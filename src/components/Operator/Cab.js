...
import {
    ...
    CardSubtitle, Button, Col, CardTitle
} from 'reactstrap'
...
export default function Cab({ cab, update }) {
    ...
    const link = (cab) => {
        ...
        if (cab === 'sedan')
            ...
            return "https://images.unsplash.com/photo-1511527844068-006b95d162c2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80";
        else if (cab === 'muv')
        ...
        <Col className="my-3">
            <Card>
                ...
                <CardBody className="text-center">
                    ...
                    <CardTitle tag="h6">Cab Id: {cab.id}</CardTitle>
                    ...
                    <Button className="ms-2" color="danger" onClick={() => { deleteCab(cab.id) }}>Delete</Button>
                </CardBody>
            </Card>
        </Col>
    )
